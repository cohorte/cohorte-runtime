...
public class CXDomUtils implements ErrorHandler {
     ...
     * 
     * <pre> CXDomUtils.cleanAllDescElements(wDocument.getDocumentElement());
     * </pre>
     * 
     * @param wElement
     * @throws Exception
    ...
    /**
     * 14w_008 - Integration WebService - creation de la methode "findTextNode"
     * 
     * @param aNode
     * @return
     */
    ...
    /**
     * 14w_007 - Integration WebService
     * 
     * @param aNode
     * @param aValue
     */
    ...
    /*
     * 14w_008 - Integration WebServices (non-Javadoc)
     * 
