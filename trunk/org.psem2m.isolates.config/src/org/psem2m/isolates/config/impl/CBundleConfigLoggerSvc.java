...
import org.psem2m.isolates.config.CBundleConfigurationActivator;
 ...
 * 
 */
public class CBundleConfigLoggerSvc extends CBundleLoggerBase implements
	IActivityLoggerBase {
	...
	setActivityLoggerBase(CBundleConfigurationActivator.getInstance());
