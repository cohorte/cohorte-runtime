 ...
 * 
 * <li>16w_104 - Fiche 50792 - Admin - Erreur de detection du fonctionnement de tomcat <li>16w_109 - enrichissement de
 * la log
 * 
 * @author ogattaz
 * 
...
public class CXFileFilterSubPath extends CXFileFilter implements FileFilter {
	...
	private HashSet<String> pListSubPath = new HashSet<String>();
	...
	public String toString() {
		...
		wSB.append(String.format("FilterSubPath(%s)=[%s]", includer(), CXStringUtils.stringTableToString(wStrs)));
		if (hasSubFileFilter())
	 ...
	 * @param aInclude
	 *          inclusion ou exclusion si un des sous dossier present dans le path
	 */
