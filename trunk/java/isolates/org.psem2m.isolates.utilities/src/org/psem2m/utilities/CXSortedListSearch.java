...
/**
 * class abstraite permettant de lister un ensemble d'object de declarant les
 * methodes pour retrouver un object selon un id first element correpond to the
 * id type and second element correspond to the Element type
 * 
 * @author ogattaz
 * 
 * @param <E>
...
public abstract class CXSortedListSearch<E> extends CXSortList<E> {
	 ...
	 * 
	 * @param Elem
	 *            : correspond to a Elem of the list
	 * @param Elem2
	 *            : correspond to a Elem of the list
	 * 
	 * @return
	...
	/**
	 * search a element follow dichotomic algorythme return object that
	 * correspond to element Id
	 * 
	 * @param an
