...
public class RemoteServiceEvent implements Serializable {
    ...
    private EndpointDescription[] pEndpoints;

    /** Service event type */
    private ServiceEventType pEventType;

    /** Service interfaces names */
    private String[] pInterfacesNames;

    /** An ID representing the service */
    private String pServiceId;

    /** Service properties */
    private Dictionary<String, Object> pServiceProperties;

    /** Source isolate ID */
    private String pSourceIsolate;
	...
	pSourceIsolate = System.getProperty("isolate.id", UNKNOWN_ISOLATE_ID);
	...
	pEventType = aEventType;
	// TODO use a constant property name
	pSourceIsolate = System.getProperty("isolate.id", UNKNOWN_ISOLATE_ID);
	pEndpoints = aEndpoints;
