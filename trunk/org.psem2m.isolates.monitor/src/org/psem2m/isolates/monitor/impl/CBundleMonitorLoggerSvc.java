 ...
 * 
 */
public class CBundleMonitorLoggerSvc extends CBundleLoggerBase implements
		IBundleMonitorLoggerService {
	...
	public void validatePojo() {
		setActivityLoggerBase(CBundleMonitorActivator.getInstance());
