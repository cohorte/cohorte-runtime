...
import org.psem2m.isolates.base.IPlatformDirsService;
 ...
 * 
 */
public class CLogChannelsServiceImpl extends CPojoBase implements
		ILogChannelsService {

	/** Service reference managed by iPojo (see metadata.xml) **/
	private IBundleLoggersLoggerService pBundleLoggersLoggerService;
	 ...
	 * 
	 */
	public CLogChannelsServiceImpl() {
		super();
	}
	...
	public void invalidatePojo() {
		...
		pBundleLoggersLoggerService.logInfo(this, "invalidatePojo", "INVALIDATE",
				toDescription());
		destroy();
	}
	...
	private IActivityLogger newLogger(final String aChannelId) throws Exception {
		...
		IActivityLogger wLogger = instanciateLogger(aChannelId,
				pPlatformDirsService.getIsolateLogDir());
	...
	public void validatePojo() {
		...
		// logs in the bundle output
		pBundleLoggersLoggerService.logInfo(this, "validatePojo", "VALIDATE",
				toDescription());

		try {
			newLogger("isolate-" + pPlatformDirsService.getIsolateId());

		} catch (Exception e) {
			pBundleLoggersLoggerService.logSevere(this, "validatePojo", e);
		}
	}
}
