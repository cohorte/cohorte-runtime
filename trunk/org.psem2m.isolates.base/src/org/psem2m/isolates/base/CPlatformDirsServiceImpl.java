 ...
 * 
 */
public class CPlatformDirsServiceImpl extends CPojoBase implements
	...
	private IBundleBaseLoggerService pBundleBaseLoggerService;

	/**
	 * Explicit default constructor
	 */
	public CPlatformDirsServiceImpl() {
		super();
	}
	...
	public void invalidatePojo() {
		...
		pBundleBaseLoggerService.logInfo(this, "invalidatePojo", "INVALIDATE",
				toDescription());
	}
	...
	public void validatePojo() {
		// logs in the bundle output
		pBundleBaseLoggerService.logInfo(this, "validatePojo", "VALIDATE",
				toDescription());
	}
