...
/**
 * getItemsStock treatment chain entry point
 * 
 * @author Thomas Calmant
 */
@Component(name = DemoComponentsConstants.COMPONENT_ENDPOINT_GETITEMSSTOCK)
@Provides(specifications = IComponent.class)
public class EndpointGetItemsStock extends CPojoBase implements IComponent {
    ...
    @Requires(id = DemoComponentsConstants.WIRE_NORMALIZER)
