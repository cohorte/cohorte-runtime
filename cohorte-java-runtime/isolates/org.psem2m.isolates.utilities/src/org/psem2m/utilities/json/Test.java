	...
	public static void main(String args[]) {
		...
		class Obj implements JSONString {
			...
			public String toString() {
				return this.getString() + " " + this.getNumber() + " " + this.isBoolean() + "."
						+ this.getBENT() + " " + this.getX();
			}
		}
		...
		try {
			...
			jj = new JSONStringer();
			s = jj.object().key("foo").value("bar").key("baz").array().object().key("quux")
					.value("Thanks, Josh!").endObject().endArray().key("obj keys")
