...
public class HTTPSession implements Session {
    ...
    public HTTPSession(final URI uri) {
    ...
    /**
     * Expose commons-httpclient host configuration, for setting configuration
    ...
    public synchronized JSONObject sendAndReceive(final JSONObject message) {
        ...
        try {
            ...
            RequestEntity requestEntity = new StringRequestEntity(
                    message.toString(), JSON_CONTENT_TYPE, null);
