 ...
 * @author Thomas Calmant
 */
@Component(name = CComponentsConstants.COMPONENT_NORMALIZER_GETITEMSSTOCK)
@Provides(specifications = IComponent.class)
public class NormalizerGetItemsStock extends CComponentPojo implements IComponent {
