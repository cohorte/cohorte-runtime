...
class Stresser(object):
    ...
    def __init__(self, name, server_host="localhost", \
        ...
        '''
        self.name = name
        self.__client = client_maps.DataServerClient(server_host, server_port)
    ...
    def scenario_1(self):
        ...
        # Get stocks
        items_ids = [item for item in items]
    ...
    def scenario_2(self):
        ...
        # Filter items
        selected_items = [item for item in stocks if item["stock"] > 0]
        ...
        for item in selected_items:
            ...
            cart_lines.append({"lineId": line, "id": item["id"], \
                               "quantity": quantity})
            line += 1

        # Prepare the cart
        cart = {"id":"cart" + self.name, "lines":cart_lines}
