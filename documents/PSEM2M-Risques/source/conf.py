# -*- coding: utf-8 -*-
#
# PSEM2M-Risques build configuration file, created by
...
htmlhelp_basename = 'PSEM2M-Risquesdoc'
...
man_pages = [('index', 'PSEM2M-Risques', u'PSEM2M-Risques Documentation', [u'Thomas Calmant, Olivier Gattaz'], 1)]
